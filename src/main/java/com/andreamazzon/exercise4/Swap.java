...
/**
 * Interface with methods to compute the value of a swap rate and of a par swap rate.
 *
...
public interface Swap {
	...
	/**
	 * It computes and returns the value of a swap at evaluation time t = 0, for a given vector of swap rates, in the case
	 * when the settlement dates of the term structure are evenly distributed with given time step
	 *
	 * @parameter swapRates, the array of doubles representing the swap rates
	...
	/**
	 * It computes and returns the value of a swap at evaluation time t = 0, for a given single swap rate (i.e., all entries of
	 * the vector of swap rates are equal to that single swap rate) when the settlement dates of the term structure are evenly
	 * distributed with given time step
	 *
	 * @parameter swapRate, the single swap rate
	 * @parameter yearFraction, the given time step
	 * @return the value of the swap
	...
	/**
	 * It computes and returns the par swap rate at evaluation time t = 0, in the case when the settlement dates
	 * of the term structure are evenly distributed with given time step
	 *
	 * @parameter yearFraction, the given time step
	 * @return the par swap rate
	 */
