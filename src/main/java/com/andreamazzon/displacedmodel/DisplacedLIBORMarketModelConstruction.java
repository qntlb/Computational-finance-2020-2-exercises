...
public class DisplacedLIBORMarketModelConstruction {
	 ...
	 * @param parameterForBlended, the parameter for the blended model
	...
	public static final LIBORModelMonteCarloSimulationModel createLIBORMarketModel(int numberOfPaths,
		...
		/*
		 ...
		 7) give the covariance model to the constructor of BlendedLocalVolatilityModel, to get another covariance model
