...
import com.andreamazzon.exercise10.MyExchangeOption;
import com.andreamazzon.exercise12.LIBORMarketModelConstructionWithFactorReduction.Dynamics;
import com.andreamazzon.exercise12.LIBORMarketModelConstructionWithFactorReduction.Measure;
	...
	public static void main(final String[] args) throws CalculationException {
		...
		for (int correlationIndex = 1; correlationIndex <= 10; correlationIndex++) {
			...
			final LIBORModelMonteCarloSimulationModel newLiborMarketModelReduced =
					LIBORMarketModelConstruction.getCloneWithModifiedCorrelation(myLiborMarketModelReduced,
							currentCorrelationDecayParameter);
